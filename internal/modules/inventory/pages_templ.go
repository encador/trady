...
func NewItemForm() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<form id=\"newItemForm\" enctype=\"multipart/form-data\"><input name=\"title\" required type=\"text\" placeholder=\"Item Name\"> <input required type=\"file\" name=\"image\" accept=\"image/png, image/jpeg\" style=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/modules/inventory/pages.templ`, Line: 32, Col: 105}
		}
